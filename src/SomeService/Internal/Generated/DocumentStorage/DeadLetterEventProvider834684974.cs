...
namespace Marten.Generated.DocumentStorage
{
    ...
    public class UpsertDeadLetterEventOperation834684974 : Marten.Internal.Operations.StorageOperation<Marten.Events.Daemon.DeadLetterEvent, System.Guid>
    {
        ...
        {
            builder.Append("select events.mt_upsert_deadletterevent(");
    ...
    public class InsertDeadLetterEventOperation834684974 : Marten.Internal.Operations.StorageOperation<Marten.Events.Daemon.DeadLetterEvent, System.Guid>
    {
        ...
        public override void ConfigureParameters(Weasel.Postgresql.IGroupedParameterBuilder parameterBuilder, Weasel.Postgresql.ICommandBuilder builder, Marten.Events.Daemon.DeadLetterEvent document, Marten.Internal.IMartenSession session)
        {
            builder.Append("select events.mt_insert_deadletterevent(");
            var parameter0 = parameterBuilder.AppendParameter(session.Serializer.ToJson(_document));
            parameter0.NpgsqlDbType = NpgsqlTypes.NpgsqlDbType.Jsonb;
            // .Net Class Type
            var parameter1 = parameterBuilder.AppendParameter(_document.GetType().FullName);
    ...
    public class UpdateDeadLetterEventOperation834684974 : Marten.Internal.Operations.StorageOperation<Marten.Events.Daemon.DeadLetterEvent, System.Guid>
    {
        ...
        public override void ConfigureParameters(Weasel.Postgresql.IGroupedParameterBuilder parameterBuilder, Weasel.Postgresql.ICommandBuilder builder, Marten.Events.Daemon.DeadLetterEvent document, Marten.Internal.IMartenSession session)
        {
            builder.Append("select events.mt_update_deadletterevent(");
            var parameter0 = parameterBuilder.AppendParameter(session.Serializer.ToJson(_document));
            parameter0.NpgsqlDbType = NpgsqlTypes.NpgsqlDbType.Jsonb;
            // .Net Class Type
            var parameter1 = parameterBuilder.AppendParameter(_document.GetType().FullName);
    ...
    public class DeadLetterEventBulkLoader834684974 : Marten.Internal.CodeGeneration.BulkLoader<Marten.Events.Daemon.DeadLetterEvent, System.Guid>
    {
        ...
        public const string MAIN_LOADER_SQL = "COPY events.mt_doc_deadletterevent(\"mt_dotnet_type\", \"id\", \"mt_version\", \"data\") FROM STDIN BINARY";

        public const string TEMP_LOADER_SQL = "COPY mt_doc_deadletterevent_temp(\"mt_dotnet_type\", \"id\", \"mt_version\", \"data\") FROM STDIN BINARY";

        public const string COPY_NEW_DOCUMENTS_SQL = "insert into events.mt_doc_deadletterevent (\"id\", \"data\", \"mt_version\", \"mt_dotnet_type\", mt_last_modified) (select mt_doc_deadletterevent_temp.\"id\", mt_doc_deadletterevent_temp.\"data\", mt_doc_deadletterevent_temp.\"mt_version\", mt_doc_deadletterevent_temp.\"mt_dotnet_type\", transaction_timestamp() from mt_doc_deadletterevent_temp left join events.mt_doc_deadletterevent on mt_doc_deadletterevent_temp.id = events.mt_doc_deadletterevent.id where events.mt_doc_deadletterevent.id is null)";

        public const string OVERWRITE_SQL = "update events.mt_doc_deadletterevent target SET data = source.data, mt_version = source.mt_version, mt_dotnet_type = source.mt_dotnet_type, mt_last_modified = transaction_timestamp() FROM mt_doc_deadletterevent_temp source WHERE source.id = target.id";

        public const string CREATE_TEMP_TABLE_FOR_COPYING_SQL = "create temporary table mt_doc_deadletterevent_temp (like events.mt_doc_deadletterevent including defaults)";
